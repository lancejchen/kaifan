...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1408669583, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/webshow_mtb0115', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1408669583, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/webshow_mtb0115', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1408669583, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/webshow_mtb0115', 'common/header_forum_forumdisplay')
;?>
