	...
	<table cellspacing="0" cellpadding="0">
			<tr>
				<td id="mood_statusinput" class="moodfm_input">
					<textarea name="message" id="message" style="width:250px; height:80px;" onfocus="handlePrompt(1);" onclick="showFace(this.id, 'message', msgstr);" onblur="handlePrompt(0);" onkeyup="strLenCalc(this, 'maxlimit')" onkeydown="ctrlEnter(event, 'add');">$defaultstr</textarea>
				</td>
            </tr>
            <tr>
				<td class="moodfm_btn">
					<button type="submit" name="add" id="add" class="mbutton">{lang publish}</button>
